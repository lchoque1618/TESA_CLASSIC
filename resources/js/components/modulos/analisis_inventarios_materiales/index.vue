        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <h1>
                            Reportes Estadísticos - Inventario de Materiales
                        </h1>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4>Stock actual de cada material</h4>
                                <div class="row">
                                    <div
                                        class="col-md-12"
                                        id="container1"
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4>Stock de material por fechas</h4>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="col-md-3">
    ...
    methods: {
        getProductos() {
            ...
            axios.get(url).then((res) => {
                this.listProductos = res.data.materials;
        ...
        grafico1() {
            this.enviando = true;
            axios
                .get("/admin/analisis_bi/stock_materials1")
                .then((response) => {
                    this.errors = [];
        ...
        grafico2() {
            this.enviando = true;
            axios
                .get("/admin/analisis_bi/stock_materials2", {
        ...
        grafico3() {
            this.enviando = true;
            axios
                .get("/admin/analisis_bi/stock_materials3", {
