                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputBorderWidth2"
                                        ...
                                        <code
                                            >.form-control-border.border-width-2</code
                                        ></label
                                    >
                                    <input
                                        type="text"
                                    ...
                                    <div class="form-group">
                                        ...
                                        >
                                            ...
                                            <label
                                                ...
                                                for="customSwitch3"
                                                >Toggle this custom switch
                                                element with custom colors
                                                danger/success</label
                                            >
                                        </div>
                                    </div>
                                    <div class="form-group">
